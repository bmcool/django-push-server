...
EMAIL_HOST_USER = ''
EMAIL_PORT = 25
EMAIL_SUBJECT_PREFIX = '[pushserver] '
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = ''
...
DATABASES = {
    'default': {
        ...
        'NAME': 'C:/AppServ/www/pushserver/database.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '=hgod485fn8-(h*ev&amp;82v0@+@yhn%znds=+b*4v7fs$6m5ohv*'
...
TEMPLATE_DIRS = (
    "C:/AppServ/www/pushserver/pushserver/templates",
...
GCM_APIKEY = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"

# -- APNS --
# Full path to the APN Certificate / Private Key .pem
APN_SANDBOX_PUSH_CERT = os.path.join(PROJECT_PATH, "xxxx.pem")
APN_LIVE_PUSH_CERT = os.path.join(PROJECT_PATH, "xxxx.pem")
